...
public class JerseyCollectionMethodGenerator {
	...
	val CollectionResource resource
	val SingleResource boundResource;
	var boolean isPaginationActive;
	var boolean isCachingActive;
	var int pagecount = 0;
	val ExceptionMapper mapper

	public new(RESTResourceObjects allResources, CollectionResource resource) {
		this.mapper = new ExceptionMapper();
		this.allResources = allResources;
		this.resource = resource;
		this.boundResource = resource.traits.collectionOf;
		analyzeResource();
	}
