...
import de.fhws.rdsl.query.transformer.spi.DefaultQueryTransformer;
...
public class SQLTransformerTest extends AbstractSQLTransformerTest {
	...
	@Test
	public void test22() {
		doTest("queryCar02.txt", "car", Lists.newArrayList(), 40l, 10l, null);
	}

	@Test
	public void test23() {
		doTest("queryCarcompaniesCompanycars06.txt", "CarcompaniesCompanycars", Lists.newArrayList(), 40l, 10l, null);
	}

	@Test
	public void test24() {
		doTest("queryCarcompaniesCompanycars07.txt", "CarcompaniesCompanycars", Lists.newArrayList(), 40l, 10l, null);
	}
	...
	private String getActual(String text, String contextType, List<Object> keys, String mapKey, Long start, Long offset, String order) {
		DefaultQueryTransformer queryTransformer = new DefaultQueryTransformer(DefaultQueryParser::new, SQLNodeTransformer::new, SQLElementTransformer::new,
		...
		query.setIdentifiers(keys);
		List<Type> types = createTypes();
		Schema schema = new Schema(types);
		try {
			return (String) queryTransformer.transform(new QueryTransformerParameters(query, contextType, schema, Maps.newHashMap())).get(mapKey);
		} catch (IOException e) {
