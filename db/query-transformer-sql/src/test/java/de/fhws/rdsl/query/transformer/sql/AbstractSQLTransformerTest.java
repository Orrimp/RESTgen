...
public class AbstractSQLTransformerTest {
	...
	private static List<Type> getTypes() {
		...
		// carcompaniesCompanycars.getMembers().add(new
		// Attribute("_cars_Company", Attribute.STRING)); // Keys
		carcompaniesCompanycars.getMembers().add(new Reference("_cars_Company", false, company, null));
		// carcompaniesCompanycars.getMembers().add(new
		// Attribute("_companies_Car", Attribute.STRING)); // Keys
		carcompaniesCompanycars.getMembers().add(new Reference("_companies_Car", false, car, null));
		...
		// companyemployeesPersoncompany.getMembers().add(new
		// Attribute("_employees_Company", Attribute.STRING)); // Keys
		companyemployeesPersoncompany.getMembers().add(new Reference("_employees_Company", false, company, null));
		// companyemployeesPersoncompany.getMembers().add(new
		// Attribute("_company_Person", Attribute.STRING)); // Keys
		companyemployeesPersoncompany.getMembers().add(new Reference("_company_Person", false, person, null));
		companyemployeesPersoncompany.getMembers().add(new Attribute("_revision", Attribute.STRING));

		// companymanagerPersonmanagedCompany.getMembers().add(new
		// Attribute("_manager_Company", Attribute.STRING)); // Keys
		companymanagerPersonmanagedCompany.getMembers().add(new Reference("_manager_Company", false, company, null));
		// companymanagerPersonmanagedCompany.getMembers().add(new
		// Attribute("_managedCompany_Person", Attribute.STRING)); // Keys
		companymanagerPersonmanagedCompany.getMembers().add(new Reference("_managedCompany_Person", false, person, null));
